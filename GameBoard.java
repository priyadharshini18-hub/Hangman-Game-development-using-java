...
public class GameBoard extends JFrame
{
     ...
     */
    public GameBoard(phantom_hangman.AudioPlayerExample1 a)
    {
        //a.play();
        phantom_hangman.AudioPlayerExample2 b=new phantom_hangman.AudioPlayerExample2();
        b.play();
        WIDTH = 500;
        HEIGHT = 500;
        MAX_INCORRECT = 6;
    ...
    private void newGameDialog()
    {
        ...
        int dialogResult = JOptionPane.showConfirmDialog(null,
                ...
                "Play Again?",
                JOptionPane.YES_NO_OPTION);
        phantom_hangman.AudioPlayerExample1 a=new phantom_hangman.AudioPlayerExample1();
        a.play();
    ...
    private class TileListener implements MouseListener
    {
        ...
        public void mousePressed(MouseEvent e)
        {
            ...
            if(source instanceof phantom_hangman.LetterTile)
            {
                char c = ' ';
                int index = 0;
                ...
                phantom_hangman.LetterTile tilePressed = (phantom_hangman.LetterTile) source;
                c = tilePressed.guess();
